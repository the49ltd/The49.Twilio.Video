...
namespace Twilio
{
	...
	static class CFunctions
	{
		...
		// extern void TVIAudioDeviceFormatChanged (TVIAudioDeviceContext _Nonnull context) __attribute__((swift_name("AudioDeviceFormatChanged(context:)"))) __attribute__((deprecated("Will not be supported in TwilioVideo v6.0+", "TVIAudioDeviceReinitialize")));
		[DllImport ("__Internal")]
		[Verify (PlatformInvoke)]
		static extern unsafe void TVIAudioDeviceFormatChanged (void* context);

		// extern void TVIAudioDeviceReinitialize (TVIAudioDeviceContext _Nonnull context) __attribute__((swift_name("AudioDeviceReinitialize(context:)")));
		[DllImport ("__Internal")]
		[Verify (PlatformInvoke)]
		static extern unsafe void TVIAudioDeviceReinitialize (void* context);
