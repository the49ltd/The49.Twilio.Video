...
*/
	...
	[Static]
	partial interface AppScreenSource
	{
	...
	[BaseType (typeof(TVIVideoSource))]
	...
	[Static]
	partial interface TVIAudioSampleRate
	{
...
*/[Protocol]
	...
	interface TVIAudioDeviceRenderer
	{
		...
		unsafe bool StartRendering (TVIAudioDeviceContext context);
...
*/
	...
	interface TVIAudioDeviceCapturer
	{
		...
		unsafe bool StartCapturing (TVIAudioDeviceContext context);
...
*/
	...
	[BaseType (typeof(NSObject))]
	interface TVIUserInterfaceTracker
	{
	...
	[Static]
	partial interface CameraSource
	{
	...
	interface TVICameraSourceDelegate
	{
		...
		void SourceInterruptionEnded (TVICameraSource source);
		...
		void SourceWasInterrupted (TVICameraSource source, AVCaptureSessionInterruptionReason reason);
		...
		void DidFailWithError(TVICameraSource source, NSError error);
		...
		void IsReportingSystemPressure(TVICameraSource source, string level);
	}
	...
	[Static]
	partial interface TVIVideoEncodingMode
	{
	...
	[Static]
	partial interface DataTrackOptionss
	{
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface TVIDefaultAudioDevice
	{
	...
	[Static]
	partial interface TVITrackPriority
	{
	...
	interface TVIVideoTrack
	{
		...
		ITVIVideoRenderer[] Renderers { get; }
	...
	interface TVIRemoteParticipantDelegate
	{
		...
		void DidPublishVideoTrack (TVIRemoteParticipant participant, TVIRemoteVideoTrackPublication publication);
		...
		void DidUnpublishVideoTrack (TVIRemoteParticipant participant, TVIRemoteVideoTrackPublication publication);
		...
		void DidPublishAudioTrack (TVIRemoteParticipant participant, TVIRemoteAudioTrackPublication publication);
		...
		void DidUnpublishAudioTrack (TVIRemoteParticipant participant, TVIRemoteAudioTrackPublication publication);
		...
		void DidPublishDataTrack (TVIRemoteParticipant participant, TVIRemoteDataTrackPublication publication);
		...
		void DidUnpublishDataTrack (TVIRemoteParticipant participant, TVIRemoteDataTrackPublication publication);
		...
		void DidEnableVideoTrack (TVIRemoteParticipant participant, TVIRemoteVideoTrackPublication publication);
		...
		void DidDisableVideoTrack (TVIRemoteParticipant participant, TVIRemoteVideoTrackPublication publication);
		...
		void DidEnableAudioTrack (TVIRemoteParticipant participant, TVIRemoteAudioTrackPublication publication);
		...
		void DidDisableAudioTrack (TVIRemoteParticipant participant, TVIRemoteAudioTrackPublication publication);
		...
		void NetworkQualityLevelDidChange (TVIRemoteParticipant participant, TVINetworkQualityLevel networkQualityLevel);
		...
		void SwitchedOffVideoTrack (TVIRemoteParticipant participant, TVIRemoteVideoTrack track);
		...
		void SwitchedOnVideoTrack (TVIRemoteParticipant participant, TVIRemoteVideoTrack track);
		...
		void DidChangePublishPriority (TVIRemoteParticipant participant, string priority, TVIRemoteAudioTrackPublication publication);
		...
		void DidChangePublishPriority (TVIRemoteParticipant participant, string priority, TVIRemoteVideoTrackPublication publication);
		...
		void DidChangePublishPriority (TVIRemoteParticipant participant, string priority, TVIRemoteDataTrackPublication publication);
	}
	...
	interface TVIRoomDelegate
	{
		...
		void DidFailToConnectWithError(TVIRoom room, NSError error);
		...
		void DidDisconnectWithError(TVIRoom room, [NullAllowed] NSError error);
		...
		void IsReconnectingWithError(TVIRoom room, NSError error);
		...
		void ParticipantDidConnect(TVIRoom room, TVIRemoteParticipant participant);
		...
		void ParticipantDidDisconnect (TVIRoom room, TVIRemoteParticipant participant);
		...
		void ParticipantIsReconnecting(TVIRoom room, TVIRemoteParticipant participant);
		...
		void ParticipantDidReconnect(TVIRoom room, TVIRemoteParticipant participant);
		...
		void DominantSpeakerDidChange(TVIRoom room, [NullAllowed] TVIRemoteParticipant participant);
	}
...
*/
	...
	[BaseType (typeof(UIView))]
	interface TVISampleBufferVideoView
	{
	...
	[Static]
	partial interface TVIBandwidthProfileMode
    {
	...
	interface TVIVideoViewDelegate
	{
		...
		[Export ("videoView:videoDimensionsDidChange:")]
		void VideoDimensionsDidChange (TVIVideoView view, CMVideoDimensions dimensions);
		...
		void VideoOrientationDidChange (TVIVideoView view, TVIVideoOrientation orientation);
	}
